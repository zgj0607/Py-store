    ...
    if result:
        ...
        body = """
            <body style="text-align: center;">
                <table width=100% CELLPADDING="0" CELLSPACING="1" border="0">
                    ...
                    """.format(storeName=storeName,carId=result[0][2],createdTime=result[0][0],carPhone=result[0][4],orderNo=result[0][1])
        ...
        for order in result:
            ...
            for td in tdList:
                ...
                """.format(tdWidth=tdWidth,one=attribute.get(keyDict[ii][0],""),two=attribute.get(keyDict[ii][1],""),
                           three=attribute.get(keyDict[ii][2],""),four=attribute.get(keyDict[ii][3],""),five=attribute.get(keyDict[ii][4],""))
...
def ImportExcel(fileName,self):
    ...
    nrows = sh.nrows
    temp = list()
    titleList = ['检索ID','orderNo','createdTime',"pcSign","carId","carUser","carPhone","carModel","workerName","project"]
