...
# Form implementation generated from reading ui file 'ui_device.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.device_table = QtWidgets.QTableView(self.layoutWidget)
        self.device_table.setMinimumSize(QtCore.QSize(941, 551))
        self.device_table.setObjectName("device_table")
        self.verticalLayout_2.addWidget(self.device_table)
