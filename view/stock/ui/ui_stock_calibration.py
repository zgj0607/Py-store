...
class Ui_stock_calibration(object):
    def setupUi(self, stock_calibration):
        ...
        self.searchButton = QtWidgets.QPushButton(stock_calibration)
        self.searchButton.setMinimumSize(QtCore.QSize(90, 26))
        self.searchButton.setMaximumSize(QtCore.QSize(90, 26))
        ...
        self.reviewButton = QtWidgets.QPushButton(stock_calibration)
        self.reviewButton.setMinimumSize(QtCore.QSize(90, 26))
        self.reviewButton.setMaximumSize(QtCore.QSize(90, 26))
        self.reviewButton.setObjectName("reviewButton")
        self.horizontalLayout_2.addWidget(self.reviewButton)
    ...
    def retranslateUi(self, stock_calibration):
        ...
        self.searchButton.setText(_translate("stock_calibration", "查询"))
        self.calibrationButton.setText(_translate("stock_calibration", "校准"))
        self.reviewButton.setText(_translate("stock_calibration", "审核"))
