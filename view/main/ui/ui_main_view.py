...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menu = QtWidgets.QMenu(self.setting)
        ...
        self.stock_calibration = QtWidgets.QMenu(self.inventory)
        self.stock_calibration.setObjectName("stock_calibration")
        ...
        self.service_manage = QtWidgets.QAction(MainWindow)
        self.service_manage.setObjectName("service_manage")
        self.attribute_setting = QtWidgets.QAction(MainWindow)
        self.attribute_setting.setObjectName("attribute_setting")
        self.do_stock_calibration = QtWidgets.QAction(MainWindow)
        self.do_stock_calibration.setObjectName("do_stock_calibration")
        self.stock_calibration_review = QtWidgets.QAction(MainWindow)
        self.stock_calibration_review.setObjectName("stock_calibration_review")
        ...
        self.menu.addAction(self.service_manage)
        self.menu.addAction(self.attribute_setting)
        self.setting.addAction(self.setting_user.menuAction())
        self.setting.addAction(self.menu.menuAction())
        ...
        self.stock_calibration.addAction(self.do_stock_calibration)
        self.stock_calibration.addAction(self.stock_calibration_review)
        ...
        self.inventory.addAction(self.stock_calibration.menuAction())
        ...
        self.menuBar.addAction(self.return_visit_customer)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.stock_calibration.setTitle(_translate("MainWindow", "库存校准"))
        ...
        self.inventory_search.setText(_translate("MainWindow", "库存明细查询"))
        self.inventory_unsalable_pre_warning.setText(_translate("MainWindow", "滞销库存预警"))
        self.stock_monitor.setText(_translate("MainWindow", "进货监控"))
        self.inventory_money.setText(_translate("MainWindow", "分类库存总览"))
        ...
        self.service_manage.setText(_translate("MainWindow", "服务管理"))
        self.attribute_setting.setText(_translate("MainWindow", "属性管理"))
        self.do_stock_calibration.setText(_translate("MainWindow", "校准"))
        self.stock_calibration_review.setText(_translate("MainWindow", "校准审核"))
