...
class Ui_stockQueryForm(object):
    def setupUi(self, stockQueryForm):
        ...
        self.out_container.setGeometry(QtCore.QRect(-512, 0, 1500, 510))
        ...
        self.out_container.setMinimumSize(QtCore.QSize(1500, 510))
        self.out_container.setMaximumSize(QtCore.QSize(1500, 510))
        ...
        self.label_15 = QtWidgets.QLabel(self.out_container)
        self.label_15.setMinimumSize(QtCore.QSize(105, 28))
        self.label_15.setMaximumSize(QtCore.QSize(105, 28))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_15.setFont(font)
        self.label_15.setObjectName("label_15")
        self.title_info.addWidget(self.label_15)
        ...
        self.first_service_1 = QtWidgets.QComboBox(self.out_container)
        self.first_service_1.setMinimumSize(QtCore.QSize(105, 28))
        self.first_service_1.setMaximumSize(QtCore.QSize(105, 28))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.first_service_1.setFont(font)
        self.first_service_1.setObjectName("first_service_1")
        self.buy_info_1.addWidget(self.first_service_1)
        self.second_service_1 = QtWidgets.QComboBox(self.out_container)
        self.second_service_1.setMinimumSize(QtCore.QSize(105, 28))
        self.second_service_1.setMaximumSize(QtCore.QSize(105, 28))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.second_service_1.setFont(font)
        self.second_service_1.setEditable(False)
        self.second_service_1.setProperty("clearButtonEnabled", False)
        self.second_service_1.setObjectName("second_service_1")
        self.buy_info_1.addWidget(self.second_service_1)
    ...
    def retranslateUi(self, stockQueryForm):
        ...
        self.label_15.setText(_translate("stockQueryForm", "一级项目"))
        self.label_3.setText(_translate("stockQueryForm", "二级项目"))
