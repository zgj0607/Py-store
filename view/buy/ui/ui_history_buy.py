...
class Ui_HistorySock(object):
    def setupUi(self, HistorySock):
        ...
        self.model_combo.setMinimumSize(QtCore.QSize(0, 26))
        self.model_combo.setMaximumSize(QtCore.QSize(16777215, 26))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.model_combo.setFont(font)
        self.model_combo.setEditable(True)
        self.model_combo.setMaxVisibleItems(100)
        self.model_combo.setSizeAdjustPolicy(QtWidgets.QComboBox.AdjustToMinimumContentsLengthWithIcon)
