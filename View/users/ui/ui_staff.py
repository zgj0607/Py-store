...
class Ui_Staff(object):
    def setupUi(self, Staff):
        ...
        self.add_staff = QtWidgets.QPushButton(self.widget)
        ...
        self.widget1 = QtWidgets.QWidget(Staff)
        self.widget1.setGeometry(QtCore.QRect(0, 550, 951, 32))
        self.widget1.setObjectName("widget1")
        self.horizontalLayout_13 = QtWidgets.QHBoxLayout(self.widget1)
        self.horizontalLayout_13.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_13.setObjectName("horizontalLayout_13")
        self.delete_staff = QtWidgets.QPushButton(self.widget1)
        ...
        self.update_staff = QtWidgets.QPushButton(self.widget1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.staff_table.setGeometry(QtCore.QRect(0, 30, 951, 520))
        self.staff_table.setMinimumSize(QtCore.QSize(951, 520))
        self.staff_table.setMaximumSize(QtCore.QSize(941, 520))
