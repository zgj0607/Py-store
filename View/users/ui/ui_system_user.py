...
class Ui_SystemUserForm(object):
    def setupUi(self, SystemUserForm):
        ...
        self.widget = QtWidgets.QWidget(SystemUserForm)
        self.widget.setGeometry(QtCore.QRect(0, 550, 941, 32))
        self.widget.setObjectName("widget")
        self.horizontalLayout_19 = QtWidgets.QHBoxLayout(self.widget)
        self.horizontalLayout_19.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_19.setObjectName("horizontalLayout_19")
        self.add_sys_user = QtWidgets.QPushButton(self.widget)
        ...
        self.change_sys_user = QtWidgets.QPushButton(self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.remove_sys_user = QtWidgets.QPushButton(self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.sys_user_table.setGeometry(QtCore.QRect(1, 1, 940, 551))
        self.sys_user_table.setMinimumSize(QtCore.QSize(940, 551))
