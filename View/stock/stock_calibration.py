...
from View.stock.stock_calibration_dialog import stock_calibrationDialog
...
class stock_calibration(QtWidgets.QWidget, Ui_stock_calibration):
    def __init__(self):
        super(stock_calibration, self).__init__()
        self.setupUi(self)
    ...
    def calibration(self):
        dialog = stock_calibrationDialog()
        dialog.exec()
