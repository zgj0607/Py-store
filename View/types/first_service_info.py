...
from View.types.ui.ui_first_service_info import Ui_MainWindow as UiFirstLevelServiceInfo
from database.dao.service.service_handler import add_first_level_service, update_service
    ...
    def _update(self):
        ...
        if '-' in name:
            ...
            if not self.service_id:
                add_first_level_service(name)
            else:
                update_service(self.service_id, name)
